        ...
        <section className="py-6 sm:py-8 md:py-10 px-4 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-8 leading-relaxed px-4">
              ...
              success in creating exceptional experiences.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed px-4">
                We are dedicated to creating exceptional experiences that bring
                people together, foster meaningful connections, and inspire
                positive change in our community. Through innovative events and
                thoughtful engagement, we strive to make every moment memorable
                and impactful.
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
                <div>
                  <p className="text-sm sm:text-base text-gray-300 leading-relaxed mb-4">
                    We envision a world where every event serves as a catalyst
                    for connection, learning, and growth. Our goal is to become
                    the leading platform that transforms ordinary gatherings
                    into extraordinary experiences.
                  </p>
                  <p className="text-sm sm:text-base text-gray-300 leading-relaxed">
                    Through cutting-edge technology, creative innovation, and
                    unwavering commitment to excellence, we aim to set new
                    standards in event management and community engagement.
                  </p>
                </div>

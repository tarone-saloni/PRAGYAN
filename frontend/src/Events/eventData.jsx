  ...
  flagship: {
    ...
    events: [
      ...
      },
      {
        ...
        tagline: "Sparks scientific curiosity in young minds",
        description:
          "Junior Scientist is a special initiative under PRAGYAA-Multiverse of Innovation, designed exclusively for school students up to Class 10. The event aims to spark scientific curiosity and hands-on learning at an early age by giving young minds a platform to explore, experiment, and innovate.",
        icon: "Trophy",
      },
      {
        id: "E-Venture ",
      ...
      },
      {
        id: "Uddan",
        title: "Uddan",
        tagline: "Soar high in the ultimate drone racing challenge",
        description:
          "An initiative aimed at empowering local students by enhancing their technical skills, fostering innovation, and providing a platform to showcase scientific and technological talent",
        icon: "Trophy",
      },
      {
        id: "Galactic Glide",
      ...
      {
        id: "Krishi PRAGYAA",
        title: "Krishi PRAGYAA",
        tagline: "Where Innovation Cultivates the Future",
        description:
          "It is a dedicated domain under PRAGYAA Multiverse of Innovation,designed to empower young minds in transforming the agricultural landscape.This platform brings together students,innovators,researchers and rural youth to showcase solutions addressing real-world farming challenges through technology, creativity and sustainable practices.The event aims to bridge the gap between traditional farming and modern innovation, inspiring to build ideas that are farmer-friendly and impactful for India's agricultural future.",
        icon: "Trophy",
      },
    ],
  },
  ...
  Departmental: {
    ...
    events: [
      ...
      },
      {
        id: "EESA - Electrospark",
        title: "EESA - Electrospark",
        tagline: "CodeQuest 2.0",
        description:
          " DSA coding competition, is a competitive programming contest focused on Data Structures and Algorithms. Its aim is to improve logic building, time bound coding skills, and prepare students for coding interviews.",
        icon: "Users",
      },
      {
        id: "ITSA",

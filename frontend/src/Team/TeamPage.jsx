    ...
    <div className="min-h-screen bg-gray-950 flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-grow relative overflow-hidden z-10">
        ...
        <section className="py-3 sm:py-4 md:py-6 px-4 relative z-10 flex flex-col justify-center items-center text-center">
          ...
          {/* Description */}
          <p className={`text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl tracking-[1px] xs:tracking-[1.5px] sm:tracking-[2px] md:tracking-[3px] my-1.5 sm:my-2 md:my-3 lg:my-4 uppercase text-gray-300 font-light max-w-4xl leading-relaxed transition-all duration-600 ease-out delay-300 ${
            isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
        ...
        <div className="flex flex-col items-center justify-center overflow-hidden py-2 sm:py-4 md:py-6 lg:py-8 px-3 sm:px-4">
          <div className="flex flex-col lg:flex-row w-full max-w-7xl h-auto lg:h-[55vh] xl:h-[60vh] gap-4 sm:gap-6 md:gap-8 lg:gap-12 items-center justify-center">
            ...
            <div className="flex-1 flex justify-center items-center w-full">
              <div className="w-full max-w-[280px] xs:max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg h-[40vh] xs:h-[45vh] sm:h-[50vh] md:h-[55vh] lg:h-[60vh] relative flex flex-col items-center" style={{ perspective: '1000px' }}>
